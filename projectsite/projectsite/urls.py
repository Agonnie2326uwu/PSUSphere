...
Class-based views
    ...
    2. Add a URL to urlpatterns:  path('', Home.as_view(), name='home')c
...
StudentList, StudentCreateView, StudentUpdateView, StudentDeleteView, OrgMemberList, OrgMemberCreateView, OrgMemberUpdateView,  OrgMemberDeleteView )
